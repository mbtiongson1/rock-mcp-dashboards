...
import { handleRegisterPost, isAllowedRedirectUri, overrideRegistrationEndpoint } from './register-route.js';
...
import type { Auth0ManagementClient } from './auth0-management.js';
